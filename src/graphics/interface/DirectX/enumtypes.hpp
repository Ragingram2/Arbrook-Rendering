...
namespace rythe::rendering::internal
{
	...
	enum class TextureType
	{
		...
		CUBEMAP = D3D11_BIND_SHADER_RESOURCE + 1,
	...
	enum class FormatType
	{
		...
		R24_UX8 = DXGI_FORMAT_R24_UNORM_X8_TYPELESS,
		R24_G8 = DXGI_FORMAT_R24G8_TYPELESS,
		...
		RGBAU = DXGI_FORMAT_R8G8B8A8_UINT,
		RGBU = DXGI_FORMAT_R8G8B8A8_UINT,
		RGU = DXGI_FORMAT_R8G8_UINT, 
		RU = DXGI_FORMAT_R8_UINT,
